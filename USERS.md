...
- **Situation — Known:** Maya finishes early and checks whether the full presentation fits together.
- **Situation — Assumed:** She encounters this pattern across multiple courses.
- **Job — Known:** She needs to identify gaps early enough for the owner to respond.
- **Job — Assumed:** She wants repair ownership recorded for later workload discussions.
- **Current approach — Known:** She monitors the deck, messages teammates, and repairs gaps when time is short.
...
- **Situation — Assumed:** Asynchronous clarification suits him better than extra meetings.
- **Job — Known:** He needs clear expectations and feedback before failure.
- **Job — Assumed:** He wants to request review without appearing unreliable.
- **Current approach — Known:** He interprets requirements, researches, edits slides, and uses group messages.
- **Current approach — Assumed:** He would use a checklist attached to his section.
- **Why unsatisfying — Known:** Invisible research, vague expectations, and late feedback waste effort.
- **Why unsatisfying — Assumed:** Replacement reduces his opportunity to learn through revision.
